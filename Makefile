...
SRCS := raytracing.c events.c cleanup.c cub3d.c doors.c inits.c inits2.c movement.c\
		...
		unload_textures.c trig_utils.c utils.c utils2.c utils3.c validate_map.c\
		get_next_line.c get_next_line_utils.c enemy.c sprites.c minimap.c floorceil.c render_utils.c\
