...
SRCS := src/bonus_textures.c src/cleanup.c src/cub3d.c src/doors.c src/enemy.c\
		...
		src/utils4.c src/utils.c src/validate_map.c

OBJS := $(SRCS:$(SRCDIR)/%.c=$(OBJDIR)/%.o)
OBJS_BONUS := $(SRCS:$(SRCDIR)/%.c=$(OBJDIR_BONUS)/%.o)

ifeq ($(shell uname), Linux)
	INCLUDES = -I./includes -I./ft_printf -I./ft_printf/libft -I/usr/include -Imlx
else
	INCLUDES = -I./includes -I./ft_printf -I./ft_printf/libft -I/opt/X11/include -Imlx
endif
